...
class Update_win(object):
    def setupUi(self, MainWindow):
        ...
        self.UPDATE.setGeometry(QtCore.QRect(270, 20, 121, 71))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.UPDATE.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        ...
        self.submit_button.setStyleSheet("QPushButton{background:LightSeaGreen}\QPushButton::hover{background:Teal}\QPushButton:flat{border:none}")
